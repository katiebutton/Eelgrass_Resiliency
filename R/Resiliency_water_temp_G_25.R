...
# RUN ANALYSIS
# -----------------------------
site_name <- "CACO_EH_Lagoon"
record_name <- "Water Temp.Water Temp@CACO_EH_Lagoon"
...
metadata <- data.frame(
  Metric = c("HDH","CDH","Warming Event","Duration warmest period",
             ...
             "SE warming event duration","May–August filter","Aggregation","Threshold","%_abv_25"),
  Description = c(
    "Hourly degrees above 25C summed over each day",
...
saveWorkbook(wb, paste0(file_name, "_WaterTempMetrics25.xlsx"), overwrite = TRUE)
